...
The dataset includes SEQN, sex, age, BMI and education status data of
250 participants. Those are missing demographic data and those are less
than 21 years old should be excluded; SEQN, sex and education should not
be numeric.
...
<img src="p8105_hw3_yj2802_files/figure-gfm/figure-1.png" width="90%" />
